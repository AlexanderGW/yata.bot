...
export const Rsi14 = async () => {
	return await Analysis.new({
		name: 'RSI',
		config: {
			inRealField: 'close',
			optInTimePeriod: 14,
...
export const Bollinger20 = async () => {
	return await Analysis.new({
		name: 'Bollinger20',
		config: {
			inRealAnalysis: await Sma20(),
			inRealField: 'outReal',
			optInTimePeriod: 20,
		},
		type: 'BBANDS',
...
export const Macd12_26_9 = async () => {
	return await Analysis.new({
